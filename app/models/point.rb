class Point < ApplicationRecord
  ...
  validates :choice, inclusion: { in: %w[Yes No Maybe reward_redemption], allow_nil: true }
  validates :result, inclusion: { in: %w[Yes No Maybe reward_redemption], allow_nil: true }
